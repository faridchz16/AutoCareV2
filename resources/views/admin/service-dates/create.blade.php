...
<div class="max-w-6xl mx-auto space-y-8">
    ...
    <div class="text-center">
        ...
        <h1 class="text-4xl font-extrabold text-white mt-2">
            Registrar fecha disponible
        </h1>

        <p class="text-slate-300 mt-2">
            Habilite una fecha y horario para que los clientes puedan registrar una atención.
        </p>
    </div>
    ...
    <div class="rounded-[32px] bg-[#132b49]/90 border border-cyan-400/10 shadow-xl p-10">
        ...
        <form action="{{ route('admin.service-dates.store') }}"
              method="POST"
              data-confirm="¿Desea registrar esta fecha disponible?">

            @include('admin.service-dates.form')
