...
<div class="max-w-6xl mx-auto space-y-8">
    ...
    <div class="text-center">
        ...
        <p class="text-slate-300 mt-2">
            Modifique la disponibilidad de atención para este servicio.
        </p>
    </div>
    ...
    <div class="rounded-[32px] bg-[#132b49]/90 border border-cyan-400/10 shadow-xl p-10">
        ...
        <form action="{{ route('admin.service-dates.update', $serviceDate) }}"
              method="POST"
              data-confirm="¿Desea actualizar esta fecha disponible?">
